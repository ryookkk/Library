...
<head>
    ...
    <title>Book Management System | Issue a new Book</title>
...
<div class="form-group">
    <label>Client Name<span style="color:red;">*</span></label>
        <input class="form-control" type="text" name="fullname" id="fullname" onBlur="getstudent()" autocomplete="off"  required />
</div>
<div class="form-group">
