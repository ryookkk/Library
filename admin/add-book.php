...
$isbn=$_POST['isbn'];
$price=$_POST['price'];
$sql="INSERT INTO  tblbooks(BookName,Cat,Author,ISBNNumber,BookPrice) VALUES(:bookname,:category,:author,:isbn,:price)";
...
<head>
    ...
    <title>Books Management System | Add Book</title>
