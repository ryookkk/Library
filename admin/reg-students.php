...
<head>
    ...
    <title>Books Management System | Manage Reg Students</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from tblclients";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->Stats);?></td>
...
<?php } else {?>
 ...
 <?php $cnt=$cnt+1;}} ?>                                      
                                ...
                                <a href="print_clients/index.php" class="btn btn-primary">Print</a>
                            </div>
