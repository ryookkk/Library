...
$author=$_POST['author'];
$sql="update  tblauthors set AuthorName=:author where id=:author_id";
$query = $dbh->prepare($sql);
$query->bindParam(':author',$author,PDO::PARAM_STR);
$query->bindParam(':author_id',$athrid,PDO::PARAM_STR);
$query->execute();
...
<?php 
$author_id=intval($_GET['author_id']);
$sql = "SELECT * from  tblauthors where id=:author_id";
$query = $dbh -> prepare($sql);
